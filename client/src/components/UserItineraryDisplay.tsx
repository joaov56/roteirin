...
import { MapPinIcon, DollarSignIcon, RefreshCwIcon } from 'lucide-react';
...
export default function UserItineraryDisplay({ itinerary, onItineraryUpdate }: ItineraryDisplayProps) {
